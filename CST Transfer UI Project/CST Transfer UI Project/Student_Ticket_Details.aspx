    ...
    <div class="container mb-3">
        ...
        <div class="row">
            ...
            <div class="col-sm-5 col-md-2 MarginInput">
                ...
                <div class="btnUpload"><asp:Button ID="btnUploadSyllabus" runat="server" Text="Upload Syllabus" Enabled="False" OnClick="btnUploadSyllabus_Click" /></div>

                <div class="btnUpload2"><asp:Button ID="btnUploadedTranscript" runat="server" Text="Upload Transcript" Enabled="True" Visible="False" OnClick="btnUploadedTranscript_Click" /></div>
                <div class="btnUpload2"><asp:Button ID="btnUploadedDoc" runat="server" Text="Uploaded Document" Enabled="True" Visible="False" OnClick="btnUploadedDoc_Click" /></div>
